...
const CHANNELS = [
  { icon: MessageCircle, title: 'WhatsApp',  value: '+91 96648 50011',       sub: 'Fastest — replies in under 4 hours', href: 'https://wa.me/919664850011',        color: 'bg-green-50 text-green-600' },
  { icon: Phone,         title: 'Call us',   value: '+91-9664850011',         sub: 'Toll-free · Mon–Sat, 9 AM–7 PM',    href: 'tel:9664850011',                   color: 'bg-blue-50 text-blue-600'   },
  { icon: Mail,          title: 'Email',     value: 'dalworld.inc@gmail.com',sub: 'Replies within 24 hours',           href: 'mailto:dalworld.inc@gmail.com',    color: 'bg-amber-50 text-amber-600' },
]
      ...
      <main className="min-h-screen bg-[#FAFBFC] pt-16">
        ...
        <div className="bg-brand-teal py-12 sm:py-16 px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="font-display text-3xl sm:text-4xl font-bold text-white mb-3">We're here to help</h1>
            <p className="text-white/70 text-sm sm:text-base max-w-xl mx-auto">
              Order ke baare mein sawaal ho, ya kuch aur — humse baat karo.
            </p>
          </div>
        </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input required type="text" value={form.name} placeholder="Ramesh Kumar"
                      ...
                      <div>
                        ...
                        <input required type="email" value={form.email} placeholder="ramesh@email.com"
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 p-5">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  JanSamaadhan Technologies Pvt. Ltd.<br />Ahmedabad, Gujarat, India
                </p>
              </div>
